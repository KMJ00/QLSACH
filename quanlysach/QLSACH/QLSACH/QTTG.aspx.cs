...
namespace QLSACH
{
    public partial class QTTG : System.Web.UI.Page
    {
        ...
        {
            kn.open();
            GridView1.DataSource = kn.GetTable("SELECT * FROM Tacgia");
            GridView1.DataBind();
        }
        public void clear()
        {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                kn.xuly("INSERT INTO Tacgia (matacgia,tentg)VALUES ('" + txtma.Text + "',N'" + txtten.Text + "')");
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                kn.xuly("update tacgia set tentg=N'" + txtten.Text + "' where matacgia = '"+txtma.Text+"'");
                ClientScript.RegisterStartupScript(this.GetType(), "alert",
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            kn.open();
             try
             {
                 ...
                 kn.xuly("delete from tacgia where matacgia = '"+txtma.Text+"'");
                 ClientScript.RegisterStartupScript(this.GetType(), "alert",
